...
public class ShapeBasedRecipeBuilder {
    ...
    public static ShapeBasedRecipeBuilder shapedRecipe(
            IItemProvider itemResult, IRecipeSerializer<?> serializer) {
    ...
    public void build(Consumer<IFinishedRecipe> consumerIn) {
        build(consumerIn, ForgeRegistries.ITEMS.getKey(itemResult));
    }
        ...
        consumerIn.accept(
                new Result(
                        ...
                        new ResourceLocation(
                                id.getNamespace(), "recipes/" + getGroup() + "/" + id.getPath()),
                        serializer));
    }
    ...
    public static class Result implements IFinishedRecipe {
        ...
        // the only way of reducing number of parameters here means adding pretty much unnecessary
        // objec parameter
        public Result(
                ResourceLocation id,
                ...
                Item itemResult,
                List<String> pattern,
                Map<Character, Ingredient> keyIngredients,
            ...
            conditions.add(TrueCondition.INSTANCE);
        }
        ...
        public void serialize(JsonObject json) {
            ...
            jsonobject1.addProperty("item", ForgeRegistries.ITEMS.getKey(itemResult).toString());
